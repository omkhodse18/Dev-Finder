...
function Card({userData}) {
    ...
    return (
        <div className='flex flex-row relative w-[full] rounded-3xl p-5 shadow-xl bg-gray-100' id='card-main-div'>
            ...
            <div className='flex flex-col gap-y-4 p-4 w-[70%] ' id='card-details-div'>
                ...
                <div className='w[100%] flex justify-center align-center' id='repo-top-div'>
                    <div className='repo-div w-[80%] flex flex-row justify-around align-center bg-gray-50 p-3 rounded-xl shadow-md' id='repo-info'>
                ...
                <div className='other-top-div'>
                    <div className='flex flex-row justify-between' id='other-div'>
